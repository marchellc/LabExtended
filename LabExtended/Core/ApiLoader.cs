...
namespace LabExtended.Core
{
    public class ApiLoader : Plugin
    {
        ...
        private static void LogPoint()
        {
            ...
            loadedAssemblies.ForEach(x => x.InvokeStaticMethods(m => m.HasAttribute<LoaderCallbackAttribute>()));
    ...
    /* Old loader (via external plugin)
    public static class ApiLoader
    {
        ...
        private static void LogPoint()
        {
            ...
            foreach (var plgu in PluginLoader.
            {
                try
                {
