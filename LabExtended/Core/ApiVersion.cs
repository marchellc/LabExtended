...
namespace LabExtended.Core
{
    ...
    public static class ApiVersion
    {
        ...
        /// </summary>
        public static VersionRange? Compatibility { get; } = new VersionRange(new Version(14, 1, 1));
        ...
        public static bool CheckCompatibility()
        {
            ...
            if (!Compatibility.HasValue || Compatibility.Value.InRange(Game)) return true;
