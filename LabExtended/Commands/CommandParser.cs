...
namespace LabExtended.Commands
{
    public static class CommandParser
    {
        ...
        public static ICommandParser FromType(Type type)
        {
            ...
            if (TryGetParser(type, out var parser))
                return parser;
            ...
            if (type.GetTypeInfo().IsGenericType)
            {
                ...
                if (definition == typeof(List<>))
                {
                    ...
                    return new ListParser(elementParser, elementType);
                }
                ...
                if (definition == typeof(Dictionary<,>))
                {
                    ...
                    return new DictionaryParser(keyParser, valueParser, genericArgs[0], genericArgs[1]);
                }
            }
