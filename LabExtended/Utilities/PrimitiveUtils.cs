...
namespace LabExtended.Utilities
{
    public static class PrimitiveUtils
    {
        ...
        public static PrimitiveObjectToy Spawn(Vector3 position, Vector3 scale, Quaternion rotation, PrimitiveType type = PrimitiveType.Capsule, PrimitiveFlags flags = PrimitiveFlags.Collidable | PrimitiveFlags.Visible, Color? color = null)
        {
